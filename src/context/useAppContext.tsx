...
export const AppProvider = ({ children }: { children: ReactNode }) => {
  ...
  return (
    <AppContext.Provider value={{
      user, setUser, balance, setBalance, totalEarned, setTotalEarned,
      userLevel, setUserLevel, invitees, setInvitees,
      totalPassiveIncome, setTotalPassiveIncome, profitPerHour, setProfitPerHour,
      claimedIndexes, setClaimedIndexes, characterId, setCharacterId,
      authToken, setAuthToken, gemData, setGemData, avatar, setAvatar
    }}>
      {children}
    </AppContext.Provider>
  );
